<div align="center">
<form action="<?php echo $this->Html->url(array("controller" => "Usuarios","action" => ""));?>" method="post" style="width:350px">
<fieldset style="border-style:groove; border-color:#333">
	<table align="center">
		...
		<tr>
			...
			<td style="padding-top:5px"> <input type="password" name="data[Usuario][clave]" /> </td>       
		</tr> 
		<tr>
			<td></td>
